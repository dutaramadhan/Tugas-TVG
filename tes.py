...
while True:
    ...
    bangun_datar=int(input("Masukan bangun datar yang ingin anda transformasikan(1. Segiempat, 2. Segitiga, 3. Lingkaran): "))
    #user memilih bangun datar segiempat
    if bangun_datar==1:
        ...
        if jenis_transformasi==1:
            ...
            shear(pts)
    #user memilih bangun datar segitiga
    elif bangun_datar==2:
        # Meminta input untuk titik 1
        x1 = float(input("Masukkan nilai koordinat x untuk titik 1: "))
        y1 = float(input("Masukkan nilai koordinat y untuk titik 1: "))
